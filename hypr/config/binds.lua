...
hl.bind(mainMod .. " + SHIFT + 4",                    hl.dsp.window.move({ monitor = MONITOR4 }))
hl.bind(mainMod .. " + SHIFT + 5",                    hl.dsp.window.move({ monitor = MONITOR5 }))
hl.bind(mainMod .. " + SHIFT + 6",                    hl.dsp.window.move({ monitor = MONITOR6 }))
...
hl.bind(mainMod .. " + Return",     hl.dsp.exec_cmd(launchPrefix .. CALCULATOR))
